...
print(paste0("A- Simple mean (equal weight): ", round(mean(df_main$gdp_impact_sh)*100,1)," %"))
print(paste0("B- Median country: ", round(median(df_main$gdp_impact_sh)*100,1)," %"))
print(paste0("C- Population weighted (2020): ", round(sum(df_main['impact_sh'] * df_main['pop_share2020'])*100,1)," %"))
print(paste0("D- Population weighted (2099): ", round(sum(df_main['impact_sh'] * df_main['pop_share2099'])*100,1)," %"))
print(paste0("E- GDP weighted (2020):", round(sum(df_main['impact_sh'] * df_main['gdp_CC_share2020'])*100,1)," %"))
print(paste0("F- GDP weighted (2099 under no climate change scenario): ", round(sum(df_main['impact_sh'] * df_main['gdp_NOCC_share2099'])*100,1)," %"))

print(paste0("G- Emission weighted (2018): ", round(sum(df_main['impact_sh'] * df_main['co2_s'])*100,1)," %"))
print(paste0("H- Cumulative emission weighted (1751-2018): ", round(sum(df_main['impact_sh'] * df_main['cumco2_s'])*100,1)," %"))
